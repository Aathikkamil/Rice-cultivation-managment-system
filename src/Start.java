...
public class Start extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1 =  new JPanel() {  
            public void paintComponent(Graphics g) {  
                Image img = Toolkit.getDefaultToolkit().getImage(  
                    Start.class.getResource("/Images/aaa.jpg"));  
        ...
        jPanel2 =  new JPanel() {  
            public void paintComponent(Graphics g) {  
                Image img = Toolkit.getDefaultToolkit().getImage(  
                    Start.class.getResource("/Images/man.png"));  
                g.drawImage(img, 0, 0, this.getWidth(), this.getHeight(), this);  
            }  
        };  ;
        ...
        jPanel3 =  new JPanel() {  
            public void paintComponent(Graphics g) {  
                Image img = Toolkit.getDefaultToolkit().getImage(  
                    Start.class.getResource("/Images/cp.png"));  
                g.drawImage(img, 0, 0, this.getWidth(), this.getHeight(), this);  
            }  
        };  ;
        ...
        btnfarmer.setBackground(new java.awt.Color(153, 153, 153));
        btnfarmer.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        btnfarmer.setText("Farmer Managment ");
        ...
        btncrop.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void btnfarmerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnfarmerActionPerformed
        ...
        FAOmanahment dao= new FAOmanahment();
            dao.show();
            this.dispose();
